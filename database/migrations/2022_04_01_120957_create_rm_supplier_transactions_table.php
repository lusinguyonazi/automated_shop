...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rm_supplier_transactions', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('rm_purchase_id')->references('id')->on('rm_purchases');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('rm_supplier_transactions');
    }
};
