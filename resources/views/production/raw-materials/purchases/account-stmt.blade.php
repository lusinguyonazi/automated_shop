...
<script type="text/javascript">
    ...
    function confirmDelete(id) {
        Swal.fire({
          ...
          if (result.value) {
            window.location.href="{{url('del-rm-acc-pv/')}}/"+id;
            Swal.fire(
    ...
    function confirmDeleteTrans(id) {
        Swal.fire({
          ...
          if (result.value) {
            window.location.href="{{url('del-rm-supp-trans/')}}/"+id;
            Swal.fire(
              "{{trans('navmenu.deleted')}}",
              "{{trans('navmenu.cancelled')}}",
              'success'
    ...
    <hr>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <form  action="{{url('rm-suppliers-transaction.show', encrypt($supplier->id))}}" method="POST">
                @csrf
                            ...
                            <div class="tab-pane" id="tab_1-1">
                                ...
                                <div class="row">
                                    <div class="col-xs-12" style="text-align: center; text-transform: uppercase; color: blue; border-bottom: 2px solid #82B1FF; margin-bottom: 8px;">
                                        ...
                                        @endif
                                        <h5>{{$shop->name}}</h5>
                                        <h6>{{trans('navmenu.creditor_account_stmt')}}<br><br>
                                        ...
                                        <table id="creditor-acc-stmt" class="table table-responsive table-striped display nowrap" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><a href="{{url('rm-purchase-payments/show-voucher' , encrypt($trans->pv_no))}}">{{ sprintf('%05d', $trans->pv_no)}}</a></td>
                                                    @else
                                                    <td style="text-align: center;"> - </td>
                                                    @endif
                                        ...
                                        <table id="example1" class="table table-responsive table-striped display nowrap" style="width: 100%;">
                                            ...
                                            @foreach($payments as $index => $trans)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">{{number_format($trans->payment)}}</td>
                                                    <td style="text-align: center;">
                                                        <a href="{{url('rm-purchase-payments/show-voucher' , encrypt($trans->pv_no))}}"><i class="bx bx-eye"></i> {{trans('navmenu.show_voucher')}}</a> | 
...
<div class="modal fade" id="payModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="POST" action="{{ url('rm-purchase-payments/accPayments')}}">
                @csrf
...
<div class="modal fade" id="adjustModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="POST" action="{{ url('rm-purchase-payments/update-adjustment')}}">
                @csrf
                <div class="modal-body row">
                    <input type="hidden" name="supplier_id" value="{{$supplier->id}}">
                    <div class="col-md-4">
                        <label class="form-label">{{trans('navmenu.invoice_no')}} <span  style="color: red; font-weight: bold;">*</span></label>
                        <select class="form-control form-select-sm mb-3" name="invoice_no" id="invoice_no" required>
                            <option value="">{{trans('navmenu.select_invoice')}}</option>
                            @foreach($purchases as $purchase)
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="inner-addon left-addon">
                            <i class="myaddon bx bx-calendar"></i>
                            <input type="text" name="adjust_date" id="adjust_date" placeholder="{{trans('navmenu.pick_date')}}" class="form-control form-control-sm mb-3" required>
                        </div>       
                    </div>
                    <div class="col-md-4">
...
<div class="modal fade" id="obModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="POST" action="{{ url('rm-purchase-payments/setOpeningBalance')}}">
                @csrf
                <div class="modal-body row">
                    <input type="hidden" name="supplier_id" value="{{$supplier->id}}">
                    @if(!is_null($obal))
            ...
            <form class="form" method="POST" action="{{ route('sms-notifications.store')}}">
                ...
                <div class="modal-body row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="sender" class="form-control form-select-sm mb-3" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone" value="{{$supplier->contact_no}}" class="form-control form-control-sm mb-3" readonly>
                    </div>
                    <div class="col-md-12">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success btn-sm">{{trans('navmenu.btn_send')}}</button>
                    <button type="button" class="btn btn-warning btn-sm" data-bs-dismiss="modal">{{trans('navmenu.btn_cancel')}}</button>
                </div>
            </form>
        </div>
