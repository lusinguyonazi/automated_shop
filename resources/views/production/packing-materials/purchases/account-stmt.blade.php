    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <hr>
            <form  id="dashform" action="{{route('pm-suppliers-transaction.show' , encrypt($supplier->id))}}" method="POST">
                @csrf
                ...
                @if(is_null($obal))
                <a href="#"  class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#obModal" data-bs-backdrop="static" data-bs-keyboard="false" style="margin-right: 5px;"><i class="bx bxs-box"></i> {{trans('navmenu.opening_balance')}}</a>
                @endif
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="tab-content py-3">
                            <div class="tab-pane " id="tab_1-0"  role="tabpanel">
                                <div id="inv-content">
                                ...
                                <a href="#" onclick="javascript:printDiv('inv-content')" class="btn btn-secondary " style="margin: 5px;"><i class="bx bx-printer"></i> Print</a>
                            </div>
                                        ...
                                        <table id="creditor-acc-stmt" class="table table-responsive table-striped display nowrap" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @if(!is_null($trans->cn_no))
                                                    <td style="text-align: center;"><a href="{{url('show-cn/'.Crypt::encrypt($trans->id))}}">{{ sprintf('%03d', $trans->cn_no)}}</a></td>
                                                    @else
                                                    <td style="text-align: center;"> - </td>
                                                    @endif
                                        ...
                                        <table id="example1" class="table table-responsive table-striped display nowrap" style="width: 100%;">
                                            ...
                                            @foreach($payments as $index => $trans)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">{{number_format($trans->payment)}}</td>
                                                    <td style="text-align: center;">
                                                        <a href="{{url('pm-purchase-payments/show-voucher' , encrypt($trans->pv_no))}}"><i class="bx bx-eye"></i> {{trans('navmenu.show_voucher')}}</a> | <a href="#" onclick="confirmDelete('<?php echo encrypt($trans->pv_no) ?>')" style="color: red;"><i class="bx bx-trash"></i> Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
          var d = new Date();
            ...
            var supplier = "<?php echo $supplier->name; ?>";
        ...
        $('#creditor-acc-stmt').DataTable({
                ...
                {extend: 'copyHtml5', footer: true},
                {
                    ...
                    title: "{{trans('navmenu.creditor_account_stmt')}} : "+supplier,
                    messageTop: duration
                },
                    ...
                    customize: function (doc) {
                        doc.content.splice(0, 1, {
                            text: [
                            {
                                ...
                                text: "{{trans('navmenu.creditor_account_stmt')}} \n",
                                bold: false,
                                fontSize: 14
                            }, {
                                text: "{{trans('navmenu.name')}} : "+supplier+" \n",
                                bold: false,
                                fontSize: 14
                            }, {
                                text: duration,
