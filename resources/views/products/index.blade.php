            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-end  px-1 py-1">
                        <ul class="nav nav-tabs nav-success" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" href="#product_list" role="tab"
                                    aria-selected="false">
                            ...
                            @if (Auth::user()->hasRole('manager') ||
                                    Auth::user()->can('add-stock') ||
                                    Auth::user()->hasRole('storekeeper') ||
                                    Auth::user()->can('add-product'))
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" href="#new_product" role="tab"
                                        aria-selected="false">
                                        <div class="d-flex align-items-center">
                            ...
                            @endif
                            @if (Auth::user()->hasRole('manager') || Auth::user()->hasRole('storekeeper') || Auth::user()->can('add-product'))
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" href="#import_file" role="tab"
                                        aria-selected="false">
                                        <div class="d-flex align-items-center">
                    ...
                    <div class="tab-content py-1">
                                ...
                                <div class="table-responsive" id="item-list">
                                    <table id="prodTable" class="table table-striped display nowrap" style="width:100%;">
                                        ...
                                        <thead>
                                            ...
                                            @else
                                                <h5>You dont have permission to see product list<h5>
                            @endif
                        ...
                        @if (Auth::user()->hasRole('manager') || Auth::user()->can('delete-product'))
                    ...
                    <div class="tab-pane fade" id="new_product" role="tabpanel">
                        ...
                        <form class="row g-3 needs-validation" method="POST" action="{{ route('products.store') }}"
                            ...
                            @csrf
                            <div class="col-sm-3">
                                <label class="form-label">{{ trans('navmenu.product_name') }} <span
                            ...
                            <div class="col-sm-3">
                                <label class="form-label">{{ trans('navmenu.basic_unit') }} <span
                                        style="color: red; font-weight: bold;">*</span></label>
                                <select class="form-select form-select-sm mb-1" name="basic_unit" required
                                    style="width: 100%;">
                            ...
                            <div class="col-sm-3">
                                <label
                                    class="form-label">{{ trans('navmenu.buying_per_unit') }}({{ $currency }})</label>
                                <input id="unit_price" type="number" autocomplete="off" min="0" step="any"
                                    name="buying_per_unit" placeholder="{{ trans('navmenu.hnt_buying_price') }}"
                                    class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-sm-3">
                                <label
                                    class="form-label">{{ trans('navmenu.selling_per_unit') }}({{ $currency }})</label>
                                <input id="unit_price" type="number" autocomplete="off" min="0" step="any"
                                    name="price_per_unit" placeholder="{{ trans('navmenu.hnt_selling_price') }}"
                                    class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-sm-3">
                                <label
                            ...
                            <div class="col-sm-3">
                                ...
                                <input id="name" type="text" name="product_no"
                                    placeholder="{{ trans('navmenu.hnt_product_no') }}"
                                    class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <textarea name="description" class="form-control form-control-sm mb-1"
                                    placeholder="{{ trans('navmenu.hnt_product_desc') }}"></textarea>
                            </div>
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-info btn-sm" type="button" data-bs-toggle="modal"
                                            data-bs-target="#category-modal" data-bs-backdrop="static"
                                            data-bs-keyboard="false">New
                                        </button>
                                    </span>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        var languageUrl = "";
        if (userlang === 'en') {
            languageUrl = "assets/plugins/libs/English.json";
        } else {
            languageUrl = "assets/plugins/libs/Swahili.json";
        }
        $.ajaxSetup({
            headers: {
