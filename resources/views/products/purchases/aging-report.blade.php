        ...
        <div class="col-md-12">
          <div class="card radius-10">
            <div class="card-header">
                <h6>{{trans('navmenu.aging_report')}}</h6>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="row">
                    <div class="col-xs-12" style="text-align: center; text-transform: uppercase; color: blue; border-bottom: 2px solid #82B1FF; margin-bottom: 8px;">
                      ...
                      @endif
                      <h6>{{Session::get('shop_name')}}</h6>
                      <h5 class="title">{{trans('navmenu.aging_report')}} <br><b>@if(app()->getLocale() == 'en'){{$duration}}@else{{$duration_sw}}@endif</b></h5>
                    </div>
                  </div>
                  <!-- Table row -->
                  <div class="row">
