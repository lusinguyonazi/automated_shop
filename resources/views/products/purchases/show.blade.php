              ...
              <div class="toolbar hidden-print">
                <div class="text-end">
                  <div class="btn-group">
                    ...
                    <a href="#" onclick="javascript:printDiv('inv-content')" class="btn bg-info " style="margin: 5px;"><i class="fa fa-print"></i> Print</a>
                    <a href="{{ url('edit-purchase/'.Crypt::encrypt($purchase->id))}}" class="btn bg-blue" style="margin: 5px;"><i class="fa fa-edit"></i> Update</a>
                  </div>
                </div>
                <hr/>
              </div>
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="qty">{{number_format($item->quantity_in)}}</td>
                          <td class="unit">{{number_format($item->buying_per_unit)}}</td>  
                          <td class="total">{{number_format($item->quantity_in*$item->buying_per_unit)}}</td>
                        </tr>
                        @endforeach
                      </tbody>
                      <tfoot>
