            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input ng-model="searchKeyword" placeholder="{{trans('navmenu.search_service')}}" class="form-control form-control-sm mb-1">
                    </div>    
                    <div class="col-sm-12">
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center" ng-repeat="servitem in servitems  | filter: searchKeyword | limitTo:10" ng-click="addSaleTemp(servitem, newservsaletemp, tempid)">
                                <div class="col-sm-10">
                                    @{{servitem.name}}<br>
                ...
                <div class="card-body">
                    <div class="row mb-1">
                        <div class="col-sm-6 d-lg-flex align-items-center mb-1 gap-1">
                            ...
                            <a href="{{url('ocamounts')}}" class="btn btn-primary btn-sm pull-right" style="margin-left: 5px;"><i class="fa fa-file-o"></i>{{trans('navmenu.new_oc_amount')}}</a>
                            @endif
                        </div>
                    ...
                    <div class="p-3 border rounded">
                        <form class="row g-3"  name="saleform" method="POST" action="{{ route('pos.store') }}" onsubmit="return validateform(this)" ng-if="saletemp">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="customer_id" id="customer_id" required class="form-select form-select-sm mb-1" ng-model="saletemp.customer_id" ng-change="updateSaleTempInfo(saletemp)" ng-options="customer.id as customer.name for customer in customers">
                                    <option value="">---{{trans('navmenu.select')}}---</option>
                                </select>
                            </div>
                            <div class="col-sm-3">
                                <label for="invoice" class="form-label">{{trans('navmenu.saledate')}}</label>
                                <select name="date_set" id="date_set" ng-model="saletemp.date_set" ng-change="updateSaleTempInfo(saletemp)" onchange="weg(this)" class="form-select form-select-sm mb-1">
                            ...
                            <div class="col-md-12">
                                <table id="discount_field" class="table table-responsive table-striped display nowrap" style="width: 100%; display: block; overflow: scroll; overflow: auto; font-size: 13px;">
                                    <tr>
                                        <th>#</th>
                                    ...
                                    <tr ng-repeat="newservsaletemp in servsaletempitems" id="temps">
                                        ...
                                        <td><input type="number" style="text-align:center; height: 20px; width: 80px; border: 1px solid #e0e0e0;" autocomplete="off" name="no_of_repeatition" ng-blur="updateSaleTemp(newservsaletemp)" ng-model="newservsaletemp.no_of_repeatition" min="1" step="1" value="@{{newservsaletemp.no_of_repeatition}}" class="form-control form-control-sm mb-1"></td>
                                        <td>
                                        @if($settings->enable_cpos)
                                            <input type="number" style="text-align:center; height: 20px; width: 100px; border: 1px solid #e0e0e0;" name="price" ng-blur="updateSaleTemp(newservsaletemp)" ng-model="newservsaletemp.price" value="@{{newservsaletemp.price}}" class="form-control form-control-sm mb-1">
                                        @else
                                            @{{newservsaletemp.price | number:2}}
                                        @endif
                                        </td>
                                        <td>@{{(newservsaletemp.price * newservsaletemp.no_of_repeatition) | number:2}}</td>
                                        <td><input type="number" min="0" step="any" style="text-align:center; height: 20px; width: 100px; border: 1px solid #e0e0e0;" name="total_discount" ng-blur="updateSaleTemp(newservsaletemp)" ng-model="newservsaletemp.total_discount" class="form-control form-control-sm mb-1"></td>
                                        @if($settings->is_vat_registered)
                                        <td ng-if="newservsaletemp.with_vat == 'no'"><select ng-model="newservsaletemp.with_vat" name="sold_in" ng-change="updateSaleTemp(newservsaletemp)" style="border: 1px solid #e0e0e0;">
                                            <option value="no">{{trans('navmenu.no')}}</option>
                                            <option value="yes">{{trans('navmenu.yes')}}</option>
                                        </select></td>
                                        <td ng-if="newservsaletemp.with_vat == 'yes'"><select ng-model="newservsaletemp.with_vat" name="sold_in" ng-change="updateSaleTemp(newservsaletemp)" style="border: 1px solid #e0e0e0;">
                                            <option value="yes">{{trans('navmenu.yes')}}</option>
                                            <option value="no">{{trans('navmenu.no')}}</option>
                                        </select></td>
                                        ...
                                        <td><a href="#" ng-click="removeSaleTemp(newservsaletemp.id)"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color: red"></span></a>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table id="discount_value" class="table table-responsive table-striped display nowrap" style="width: 100%; display: none; overflow: scroll; overflow: auto;">
                                    ...
                                    <tr ng-repeat="newservsaletemp in servsaletempitems" id="temps">
                                        <td>@{{$index + 1}}</td>
                                        <td>@{{newservsaletemp.name}}</td>
                                        <td><input type="number" style="text-align:center; height: 20px; width: 80px; border: 1px solid #e0e0e0;" autocomplete="off" name="no_of_repeatition" ng-blur="updateSaleTemp(newservsaletemp)" string-to-number ng-model="newservsaletemp.no_of_repeatition" min="1" step="1" value="@{{newservsaletemp.no_of_repeatition}}" class="form-control form-control-sm mb-1"></td>
                                        <td>
                                        @if($settings->enable_cpos)
                                            <input type="number" style="text-align:center; height: 20px; width: 100px; border: 1px solid #e0e0e0;" name="price" ng-blur="updateSaleTemp(newservsaletemp)" string-to-number ng-model="newservsaletemp.price" value="@{{newservsaletemp.price}}" class="form-control form-control-sm mb-1">
                                        @else
                                            @{{newservsaletemp.price | number:2}}
                                        @endif
                                        </td>
                                ...
                                <div class="col-xl-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6" id="amount_paid" style="display: none;">
                                            ...
                                            <input type="number" min="0" class="form-control form-control-sm mb-1" id="add_payment" string-to-number ng-model="add_payment" placeholder="{{trans('navmenu.hnt_amount_paid')}}" name="amount_paid" />
                                        </div>
                                        @else
                                        ...
                                        <div class="col-sm-6" id="invoice_no" style="display: none;">
                                            ...
                                            <input type="text" class="form-control mb-1" id="invoice" placeholder="Enter Invoice Number" name="inv_no" />
                                        </div> 
                                        @endif  
                                        @endif
                                        <div class="col-sm-12">
                                            <label for="employee" class="form-label">{{trans('navmenu.comments')}}</label>
                                            <textarea  class="form-control form-control-sm mb-1" name="comments" id="comments" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <table class="table " style="width: 100%;">
                                        ...
                                        <tr id="total_discount_field" style="display: none;">
                                            ...
                                            <th><input type="number" style="text-align:center;" name="sale_discount" ng-blur="updateSaleTempDiscount(servsaletempitems)" string-to-number ng-model="total_discount" value="@{{sumDiscount(servsaletempitems)}}" class="form-control form-control-sm mb-1"></th>
                                        </tr>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                              ...
                              <input type="text" name="name" required placeholder="{{ trans('navmenu.hnt_customer_name') }}" class="form-control">
                        </div>
                        
                        <div class="col-sm-6">
                              <label class="form-label">{{trans('navmenu.phone_number')}}</label>
                              <input type="text" name="phone" placeholder="{{trans('navmenu.hnt_customer_mobile')}}" class="form-control"  data-inputmask='"mask": "9999999999"' data-mask>
                        </div>
                        ...
                        <div class="col-sm-6">
                              ...
                              <input type="text" name="tin" placeholder="{{trans('navmenu.hnt_customer_tin')}}" class="form-control"  data-inputmask='"mask": "999-999-999"' data-mask>
                        </div>
                        <div class="col-sm-6">
                              <label class="form-label">{{trans('navmenu.vrn')}}</label>
                              <input type="text" name="vrn" placeholder="{{trans('navmenu.hnt_customer_vrn')}}" class="form-control">
                        </div>
                        <div class="col-sm-6">
