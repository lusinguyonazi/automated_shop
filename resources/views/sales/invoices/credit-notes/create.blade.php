            ...
            <div class="card-body">
                <form class="row g-3" method="POST" action="{{route('credit-notes.update', $creditnote->id)}}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="inv_no" class="form-control" value="{{ sprintf('%05d', $invoice->inv_no)}}" readonly>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Invoice Date :</label>
                        <input type="text" name="date" class="form-control" value="{{date('d, M Y', strtotime($invoice->created_at))}}" readonly>
                    </div>
