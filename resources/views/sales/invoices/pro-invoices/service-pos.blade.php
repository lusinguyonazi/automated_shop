                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" id="no_items" name="no_items" value="@{{invoicetemp.length}}" class="form-control col-sm-4" readonly>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div >
                                    ...
                                    <div class="col-sm-8">
                                        <p class="form-control-static"><b>@{{sum(servinvoicetemp) | number:0}}</b></p>
                                    </div>
                                </div>
                               ...
                               @if($settings->is_vat_registered) 
                                <div>
                                    ...
                                    <div class="col-sm-8">
                                        <p class="form-control-static"><b>@{{(sumTax(servinvoicetemp)) | number:0}}</b></p>
                                    </div>
                                </div>
                             @endif
                                ...
                                <div>
                                    ...
                                    <div class="col-sm-8">
                                        <p class="form-control-static"><b>@{{(sum(servinvoicetemp)-discount)+(shipping_cost+adjustment)+sumTax(servinvoicetemp) | number:0}}</b></p>
                                    </div>
                                </div>
                                <div class="row" >
                                    <div class="col-sm-6">
