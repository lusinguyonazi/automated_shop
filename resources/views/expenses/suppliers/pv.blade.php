	  ...
	  <div class="card radius-10">
	    <div class="card-header">
	      <div class="btn-group float-start">
	        <a href="#" onclick="javascript:savePdf()" class="btn btn-warning " style="margin: 5px;"><i class="bx bx-download"></i> Download PDF</a>
	    ...
	    <div class="card-body">
	          <div id="inv-content">
	              ...
	              <div class="invoice-content">
	                ...
	                <div class="title text-center"><h4>Payment Voucher</h4></div>
	                ...
	                <table border="0" cellspacing="0" cellpadding="0">
	                  <thead>
	                    <tr>
	                      ...
	                      <!-- <th class="unit">{{trans('navmenu.currency')}}</th> -->
	                  ...
	                  <tbody>
	                    ...
	                    <tr>
	                      ...
	                      <td class="desc"><h6>{{trans('navmenu.pay_for')}} {{date('d M, Y', strtotime($pay->time_created))}} {{trans('navmenu.paid_on')}} {{date('d.m.Y', strtotime($voucher->date))}}</h6></td>
	                      <td class="qty">{{ sprintf('%04d', $pay->invoice_no)}}</td>
	                      <!-- <td class="unit" style="text-align: center;">{{$settings->currency}}</td> -->
	                      <td class="total">{{number_format($pay->amount_paid)}}</td>
	                    </tr>
	                    @endforeach
	                  </tbody>
	                </table>
	                <div class="no-break">
	                  <table class="grand-total">
	                    <tbody>
	                      ...
	                      <tr>
	                        <td class="desc"></td>
	                        <td class="unit" colspan="2">GRAND TOTAL ({{$settings->currency}}):</td>
	                        <td class="total">{{number_format($voucher->payment)}}</td>
	                      </tr>
	                    </tbody>
	                  </table>
